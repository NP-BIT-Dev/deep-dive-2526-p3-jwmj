...
const OverOns = () => {
    ...
    <div class="max-w-7xl mx-auto px-4 py-8 flex flex-col md:flex-row items-center justify-center gap-4">
        <div class="flex items-center justify-center mb-8 bg-gray-100 rounded-3xl w-3/4 h-96 order-2 md:order-1">
            placeholder
        </div>
        <div class="flex flex-col items-start justify-center text-start mb-8 w-full md:w-3/4 order-1 md:order-2">
            <h2 class="text-3xl font-bold text-gray-800 mb-4 text-start">Over Schrijvershoek</h2>
            <p class="text-gray-600 mb-6 text-start">lorum ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. lorum ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
        </div>
    </div>

    <h2 class="text-3xl font-bold text-gray-800 mb-4 text-center">Contact</h2>
