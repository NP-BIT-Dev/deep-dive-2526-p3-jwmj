...
def delete_bestuurders(member_id: int, db: Session = Depends(get_db)):
    success = bestuurders_service.delete_bestuurders(db, member_id)
    if not success:
